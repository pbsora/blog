...
const PostDetail = (/* props: Props */) => {
  ...
  return (
    <motion.div
      className="w-screen md:px-16 lg:px-32 md:w-[80vw] lg:w-[70vw] xl:w-[60vw] bg-black  h-full text-white font-roboto px-5 py-5 flex flex-col gap-3 m-auto md:my-6 md:rounded-3xl"
      initial={{ x: -10000 }}
